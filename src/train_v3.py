...
from .dataset import BEHAVIOR_TO_ID, create_datasets
...
JSONL_PATH = "synthetic_interactions_v3.jsonl"
...
def main():
    ...
    model = RecRec(
        ...
        num_behavior_types=len(BEHAVIOR_TO_ID),
